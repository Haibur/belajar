                    ...
                    <tbody>
                        ...
                        foreach ($Transaksi as $vcustomer) : ?>
                            <tr class="text-gray-700 dark:text-gray-400 bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <?php echo $vcustomer->StatusAccount; ?>
                                </td>
                                <?php
                                $Pembayaran = $vcustomer->status_code;
                                $Account = $vcustomer->StatusAccount;
                                if ($Account == "Tidak Aktif" & $Pembayaran == 200) {
                                    echo "
                                            <td class='px-4 py-3 text-sm'>
                                            <a href='https://cangkulterus.com/TK/Admin/Transaksi/SendMail/$orderid'
